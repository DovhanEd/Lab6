...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style ="width:50%">
        ...
        <div style ="color:black; font-size:medium; font-weight:bolder">
            Число 1 : <asp:TextBox ID="TextBox1" runat="server" Width="100px"></asp:TextBox>
            Число 2 : <asp:TextBox ID="TextBox2" runat="server" Width="100px"></asp:TextBox>
        </div>
        <br />
        <div>
            <asp:Button ID="Button1" runat="server" Text="Додати" OnClick="Button1_Click" Width="80px" />&nbsp;
            <asp:Button ID="Button2" runat="server" Text="Відняти" OnClick="Button2_Click" Width="80px"  />
            &nbsp; 
